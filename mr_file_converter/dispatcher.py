...
def setup_dispatcher(
    ...
    dispatcher.add_handler(CommandHandler(command='help', callback=command_service.help))
    dispatcher.add_handler(CommandHandler(command='start', callback=command_service.start))
